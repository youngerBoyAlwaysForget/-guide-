...
//        NSTimer *timer = [NSTimer timerWithTimeInterval:self.graceTime target:self selector:@selector(handleGraceTimer:) userInfo:<#(nullable id)#> repeats:<#(BOOL)#>]
//    }
//}
//- (void)handleGraceTimer:(NSTimer *)theTimer {
//    // Show the HUD only if the task is still running
//    if (!self.hasFinished) {
//        [self showAnimated:self.useAnimation];
//    }
//}
