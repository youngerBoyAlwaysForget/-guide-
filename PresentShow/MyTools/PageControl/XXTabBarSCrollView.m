...
@implementation XXTabBarScrollView
...
- (void)setup {
    ...
    if (self.tabBarStyle == XXTabBarStyleCursorUnderline) {
        [self createCursorUnderline];
    } else if (self.tabBarStyle == XXTabBarStyleCursorSolid) {
        [self createCursorSolidOrHollow:YES];
    } else if (self.tabBarStyle == XXTabBarStyleCursorHollow) {
...
- (void)setCursorColor:(UIColor *)cursorColor {
    ...
    if (self.tabBarStyle == XXTabBarStyleCursorUnderline) {
        ...
        if (self.tabBarStyle == XXTabBarStyleCursorSolid) {
            view.backgroundColor = cursorColor;
        }
    }
}
...
- (void)layoutSubviews {
    ...
    if (self.tabBarStyle == XXTabBarStyleCursorSolid || self.tabBarStyle == XXTabBarStyleCursorHollow) {
        UIView *view = [self.cursorView.subviews firstObject];
